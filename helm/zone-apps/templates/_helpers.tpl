...
{{- if and .Values.server.enabled $persistence.enabled (not .Values.server.autoscaling.enabled) (eq (int .Values.server.replicaCount) 1) -}}
{{ include "zone-apps.fullname" . }}-agent-state
{{- end -}}
{{- end }}
