...
print_next_steps() {
    ...
    echo -e "     ${BLUE}OPENVPN_USER${NC} and ${BLUE}OPENVPN_PASSWORD${NC}"
    echo -e ""
    echo -e "  3. Update domain names for your setup:"
    echo -e "     ${BLUE}WEBUI_HOST${NC}, ${BLUE}API_HOST${NC}, etc."
    echo -e ""
    ...
    echo -e "     ${BLUE}https://${WEBUI_HOST:-webui.localhost}${NC}"
    echo -e ""
    echo -e "${GREEN}═══════════════════════════════════════════════════════════${NC}\n"
}
