...
printf placeholder >"$models/upscale_models/RealESRGAN_x4plus.pth"
...
COMFYUI_BASE_URL="http://127.0.0.1:$stub_port" \
...
COMFYUI_TRAIN_COMMAND="$root/scripts/live-verify/stand-in-trainer.sh" \
