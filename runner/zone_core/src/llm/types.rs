...
///
/// LiteLLM normalises generated images into `message.images` and
...
mod tests {
    ...
    #[test]
    fn test_chat_response_with_generated_images() {
        let json = r#"{
            "id": "chatcmpl-image",
            "object": "chat.completion",
            "created": 1677652288,
    ...
    #[test]
    fn test_chat_stream_chunk_with_generated_images() {
        let json = r#"{
            "choices": [{
                "index": 0,
                "delta": {
    ...
    #[test]
    fn test_chat_stream_chunk_accepts_null_images() {
        let json = r#"{
            "choices": [{
                "index": 0,
                "delta": {"images": null},
